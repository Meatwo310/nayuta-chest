...
import io.github.meatwo310.nayutachest.client.renderer.NayutaChestBERenderer;
...
public class ClientMod {
    ...
    public static void onRegisterRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(ModBlockEntities.NAYUTA_CHEST.get(), NayutaChestBERenderer::new);
    }
}
